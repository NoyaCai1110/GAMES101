...
void rst::rasterizer::rasterize_triangle(const Triangle& t) {
    ...
    x_min = floor(std::MIN(v[0].x(), std::MIN(v[1].x(), v[2].x())));
    x_max = ceil(std::MAX(v[0].x(), std::MAX(v[1].x(), v[2].x())));
    y_min = floor(std::MIN(v[0].y(), std::MIN(v[1].y(), v[2].y())));
    y_max = ceil(std::MAX(v[0].y(), std::MAX(v[1].y(), v[2].y())));
